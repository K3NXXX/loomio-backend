...
export class InviteService {
	...
	async declineInvite(userId: string, inviteId: string) {
		...
		if (!isRecipient) throw new ForbiddenException('You are not allowed to decline this invite');

		if (invite.status !== 'PENDING') throw new BadRequestException('Invite is no longer active');
